...
def declare_arguments():
    return LaunchDescription(
        [
            DeclareLaunchArgument("use_sim_time", default_value="false", description="Launch RViz?"),
            DeclareLaunchArgument("ur_type", default_value="ur10", description="Typo/series of used UR robot."),
            DeclareLaunchArgument("env", default_value="real", description="Environment type: real or gazebo"),
        ]
    )
